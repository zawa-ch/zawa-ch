<template>
	<ArticlePageTemplate title="せいかく">
		<CardView title="自覚">
			<ul>
		...
		<CardView title="各種診断実行結果">
			...
			<div>
				...
				<FolderView title="詳細" :expanding="false">
					...
					<ProgressGauge label="6" value-display="value" color="var(--accent-color)" :max="42" :value="42" />
					...
					<ProgressGauge label="sx" value-display="value" color="var(--accent-color)" :max="24" :value="24" />
				</FolderView>
				<FolderView title="履歴" :expanding="false">
					<ul>
